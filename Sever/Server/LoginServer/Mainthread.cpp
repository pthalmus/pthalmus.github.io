...
bool MainThread::StartNetSetting()
{
	...
	CreateIoCompletionPort((HANDLE)m_umListenSocket[NetLine::NetLine_LoginS_User], m_hIocp, (ULONG_PTR)m_umListenSocket[NetLine::NetLine_LoginS_User], 0);
	if (PostAccept(NetLine::NetLine_LoginS_User) == false)
	{
		return false;
	}
	return true;
